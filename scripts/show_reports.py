...
KNOWN_REPORTS = (
    ...
    ("pm_check_report.txt", "Проверки траекторий: зарезы, столкновения (пункт 35)"),
    ("pm_check_result.txt", "Проверки: строки отчёта макроса (CHK)"),
    ("pm_nc_report.txt", "NC-программа: что выведено (пункт 36)"),
    ("pm_nc_result.txt", "NC: строки отчёта макроса (NC)"),
